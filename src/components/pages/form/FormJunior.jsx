...
import './ComponenteScroll.css';
 // Ajusta la ruta según la ubicación de tu imagen
...
const RegistrationForm = ({ categories }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('./register_junior.php', {
        method: 'POST',
        body: formDataToSend,
      });
  ...
  export const Principal = () => {
    const categories = [
      { id: 'SEGUIDOR DE LINEA 16-', name: 'SEGUIDOR DE LINEA', price: 25 },
      { id: 'MINISUMO 16-', name: 'MINISUMO', price: 25 },
      { id: 'MINIHUMANOIDE 16-', name: 'MINIHUMANOIDE', price: 25 },
      { id: 'LIBRE 16-', name: 'LIBRE', price: 25 },
    ];
        ...
        <div className="scroll-container">
          ...
          >
            <Typography 
              ...
              gutterBottom 
            >
              Registro de Competencia menores de 16 años
            </Typography>
            <Box>
